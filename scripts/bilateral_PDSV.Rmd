...
mean_across_stance %>% 
  ...
  scale_color_manual(
    ...
    labels = c("IPSI_BeltSpeed" = "Stance Limb", "CONTRA_BeltSpeed" = "Contralateral Limb") # Added labels for each color
  )
...
mean_across_stance %>% 
  ...
  labs(
    ...
    title = "Ankle Torque Across Across Stance Phase",
...
plt <- PF_impulse %>% 
  ...
  labs(
    ...
    title = "Ankle PF Impulse Across Stance Phase by Period",
  )
...
mean_across_stance %>% 
  ...
  summarize(Pelvis_COM = mean(value)) %>%steps
