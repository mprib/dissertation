...
## Paretic PlantarFlexion: LNPS only
...
conditions <- list( "FastProp", "cSBT" )
       
test_sample_sizes = 60:62
for (n in test_sample_sizes){
  
    num_simulations = 40
    
    # Running simulation  s in parallel
    aim_2_pf_results <- lapply(1:num_simulations, function(i) {
      simulate_aim(n, conditions, pre_means, pre_std_devs, post_means, post_std_devs, effect_name = "condition")
    })
...
## Paretic PlantarFlexion: LPS and LNPS
