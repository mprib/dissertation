...
ggsave(file.path(figure_folder,"belt_speeds_all.png"))
```
...
ggsave(file.path(figure_folder,"belt_speed_diff_all.png"))
```
...
ggsave(file.path(figure_folder,"belt_speed_change_point_all.png"))
...
ggsave(file.path(figure_folder,"steps_by_period.png"))
```
...
ggsave(file.path(figure_folder,"pf_torque_5.png"))
...
tidy_data_by_period %>% 
  ...
  geom_path()+
  facet_grid(cols = vars(period), rows = vars(condition))
ggsave(file.path(figure_folder,"pf_torque_avg.png"))
